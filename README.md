...
- **75.8 t/s Decode** (p50, batch32 + Metal Trace + fused RoPE + multicore argmax + tuned sharded rms_norm; peak 80.6 t/s at min latency)
- **+134% faster than bfp4** at half the storage
