...
- **85.5 t/s Decode** (p50, batch32 + Metal Trace + fused RoPE + multicore argmax + tuned sharded rms_norm + split lm_head; peak 90.9 t/s at min latency)
- **+164% faster than bfp4** at half the storage
